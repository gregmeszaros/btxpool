...
class HTMLTable2JSON {
	...
	public function tableToJSON($url, $firstColIsRowName = TRUE, $tableID = '', $ignoreCols = NULL, $headers = NULL, $firstRowIsData = FALSE, $onlyColumns = FALSE, $arrangeByRow = FALSE, $ignoreHidden = FALSE, $printJSON = TRUE, $testingTable = NULL, $fileName = FALSE) {
		$ignoring = FALSE;
		$excluding = FALSE;
		if (NULL != $onlyColumns){
		...
		if ($printJSON) {
			...
			// Add a custom filename if defined
      if ($fileName) {
